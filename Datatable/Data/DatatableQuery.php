...
class DatatableQuery
{
    ...
    public function getResponse($buildQuery = true,$paginateOptions = null)
    {
        ...
        if (is_array($paginateOptions) && array_key_exists('use_knp_paginator',$paginateOptions) && $paginateOptions['use_knp_paginator'] == true) { // Use KNP PAGINATOR AND WRAP QUERY
            ...
            if (is_array($paginateOptions) && array_key_exists('use_output_walker',$paginateOptions) && $paginateOptions['use_output_walker']==true)
