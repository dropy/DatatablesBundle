/**
 * Created by Jeremy on 13/07/2016.
 */
/**
...
(function ($) {
    ...
    $.fn.dataTableExt.oPagination.input = {
        'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
            ...
            nFirst.innerHTML = '<a>'+language.sFirst+'</a>';
            nPrevious.innerHTML = '<a>'+language.sPrevious+'</a>';
            nNext.innerHTML = '<a>'+language.sNext+'</a>';
            nLast.innerHTML = '<a>'+language.sLast+'</a>';
            ...
            paginationContainer.appendChild(nFirst);
            paginationContainer.appendChild(nPrevious);
            paginationContainer.appendChild(nPage);
            paginationContainer.appendChild(nOf);
            paginationContainer.appendChild(nNext);
            paginationContainer.appendChild(nLast);
            nPaging.appendChild(paginationContainer);
